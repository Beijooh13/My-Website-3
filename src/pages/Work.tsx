...
const projects: Project[] = [
  ...
  { id: 'holiday-world', title: 'Holiday World — Apparel Collection', year: '2025', category: 'Objects', localImg: 'hw1', size: 'wide' },
  ...
  { id: 'asta-graphics', title: 'AStA HSRW — Event Graphics & PR', year: '2025', category: 'Graphic Design', localImg: 'astaThumb', size: 'tall' },
]
