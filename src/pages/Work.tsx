...
import realEstateThumb from '@/imports/ Real Estate Photography_001.jpg'
...
const localImgMap: Record<string, string> = { hw1, portraitD, branson3, codeGreen, essentia, perfume, landscape, zamoraSocial, podcast, astaThumb, danceThumb, labThumb, klingerThumb, rvnThumb, lunitThumb, cyconThumb, suitmakeThumb, ngaThumb, realEstateThumb }
