...
const projects: Project[] = [
  ...
  { id:'dance-competition-photography', title:'Dance Competition Photography — Same Day Productions', year:'2022–2024', category:'Photography', localImg:'heatThumb', size:'tall' },
  { id:'usability-lab-documentation', title:'HSRW Usability Lab — Photographic Documentation', year:'2026', category:'Photography', localImg:'chessThumb', size:'wide' },
  { id:'klingerhuf-restoration', title:'Klingerhuf Restoration — Community Participation', year:'2026', category:'Community', localImg:'klingerhufThumb', size:'wide' },
...
const localImgMap: Record<string,string> = { hw1, portraitD, branson3, codeGreen, essentia, perfume, landscape, zamoraSocial, podcast, astaThumb, heatThumb, chessThumb, klingerhufThumb, rvnThumb, lunitThumb, conunThumb }
