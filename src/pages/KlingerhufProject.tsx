...
import poster from '@/imports/Klingerhuf Restoration Event_Reel_01.png'
    ...
    <article className="page-enter" style={{ backgroundColor: 'var(--color-paper)' }}>
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-4 space-y-5">
            {[
              ...
              ['Partner', 'Stay to Grow'],
              ['Outputs', 'Main event graphic and carousel artwork'],
              ['Year', '2026'],
          ...
          <div className="md:col-span-7 md:col-start-6">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ fontFamily:'var(--font-body)', color:'var(--color-muted)' }}>The Klingerhuf restoration activity was organized in partnership with Stay to Grow. I did not organize the event itself. My contribution was to create the promotional graphics, use photography within the visual communication, help promote the opportunity to students, and participate in the restoration as a volunteer.</p>
      ...
      <section className="px-8 md:px-16 pb-24">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
          <img src={poster} alt="Klingerhuf restoration main event graphic" className="w-full h-auto block" />
          <img src={c1} alt="First Klingerhuf restoration carousel image" className="w-full h-auto block" />
        </div>
      </section>
      ...
      <section className="py-28 px-8 md:px-16" style={{ backgroundColor:'var(--color-ink)' }}>
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-4"><p className="text-[10px] tracking-[0.3em] uppercase" style={{ color:'var(--color-muted)', fontFamily:'var(--font-body)' }}>Why it matters</p></div>
          <div className="md:col-span-7"><p className="text-2xl md:text-3xl leading-relaxed text-white" style={{ fontFamily:'var(--font-display)' }}>The design was one part of the experience. Its job was to make participation feel clear, approachable, and worth showing up for.</p></div>
        </div>
      </section>
    </article>
  )
