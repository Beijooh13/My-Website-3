...
export default function KlingerhufProject({ navigate }: Props) {
  return (
    <article className="page-enter" style={{ backgroundColor: 'var(--color-paper)' }}>
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-4 space-y-5">
            {[
              ...
              ['Outputs', 'Event poster and social media carousel'],
              ['Year', '2026'],
          ...
          <div className="md:col-span-7 md:col-start-6">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ fontFamily:'var(--font-body)', color:'var(--color-muted)' }}>The Klingerhuf restoration activity was organized with Stay to Grow. I did not organize the event itself. My contribution was to create the promotional graphics, use photography within the visual communication, help promote the opportunity to students, and participate in the restoration as a volunteer.</p>
      ...
      <section className="px-8 md:px-16 pb-24"><div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4"><img src={poster} alt="Klingerhuf restoration event poster" className="w-full h-auto block" /><img src={c1} alt="Klingerhuf restoration social media carousel" className="w-full h-auto block" /></div></section>
